...
const PropertyImages = ({ images }) => {
  ...
  return (
    <>
      {/* Preview Grid */}
      <div className="grid grid-cols-2 gap-2 w-7xl mx-auto h-[500px]">
        ...
        {testimonials.map((item, index) => {
          ...
          return (
            <div key={index} className="px-2 mb-6">
              <div
  className={`relative rounded-xl p-6 pt-16 bg-white shadow-md transition-all duration-300 overflow-visible ${
    isActive ? "scale-100 opacity-100 shadow-lg" : "scale-95 opacity-70"
  }`}
>
  <img
    src={item.image}
          ...
          <div className="flex-1">
            <div className="flex justify-between">
              ...
              <div className="flex items-center gap-4 text-[#262626] text-sm">
                ...
                <span className="px-2 py-0.5 bg-green-100 text-green-600 rounded-md text-xs font-medium">
                  Active
                </span>
            ...
            {/* Price & Rating */}
            <div className="mt-4">
              <h2 className="text-2xl font-bold text-[#D7B56D] ">₹18,000/month</h2>
            ...
            <div className="mt-3 flex items-center gap-2 text-[#404040] ">
              ...
              <span className="font-[600] ">
                Maruti Mandir Chowk, Talegaon Dabhade, Pune – 410506
              </span>
            </div>
